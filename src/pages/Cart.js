        ...
        <article>
            <div className="dt w-100 bb b--black-10 pb2 mt2 dim blue" href="#0">
                ...
                <div className="dtc v-top pl2">
                    ...
                    <h2 className="f6 fw4 mt2 mb0 black-60">Michael Jordan</h2>
                    <dl className="mt2 f6">
                    ...
                    <button className="f6 link dim br3 ph3 pv1 mb2 dib white bg-red" onClick={() => handleRemove(index)}>Remove from cart</button>
                </div>
            </div>
        </article>
    );
